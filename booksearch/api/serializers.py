...
class NewBookSerializer(serializers.ModelSerializer):
    class Meta:
        model = Book
        fields = ['google_id', 'title', 'author_c', 'author', 'category', 'summary', 'published', 'preview_link', 'language', 'imageLinks', 'selfLink', 'isbn', 'epub', 'embeddable', 'preview_link_new', 'user_num_b', 'surname', 'owner']
...
class BookToAuthorSerializer(serializers.ModelSerializer):
    class Meta:
        model = Book
        fields = ['google_id', 'title', 'author_c', 'author', 'category', 'summary', 'published', 'preview_link', 'language', 'imageLinks', 'selfLink', 'isbn', 'epub', 'embeddable', 'preview_link_new', 'user_num_b', 'surname', 'owner']
