...
context_bm_bs['no_date'] = datetime.date(3000, 1, 1)
context_bm_bs['url_img_book'] = url_img
context_bm_bs['url_img_author'] = url_img_author
...
def gbsearch_book(request):
    ...
    #         context_bm_bs['allbooks'] = all_books
    #         context_bm_bs['num_books'] = num_books
    #     elif not Book.objects.all():
    #     # elif not Book.objects.filter().all():
    #         context_bm_bs['allbooks'] = None
    #         context_bm_bs['num_books'] = 0
    # except:
    ...
    #         num_authors = Author.objects.all().count()
    #         context_bm_bs['allauthors'] = all_authors
    #         context_bm_bs['num_authors'] = num_authors
    #     elif not Author.objects.all():
    #     #elif not Author.objects.filter().all():
    #         context_bm_bs['allauthors'] = None
    #         context_bm_bs['num_authors'] = 0
    # except:
    ...
    try:
        if BackgroundPoster.objects.filter().last():
            ...
            context_bm_bs['poster_url_1'] = poster.link_poster_1
            context_bm_bs['poster_url_2'] = poster.link_poster_2
        elif not BackgroundPoster.objects.filter().last():
            context_bm_bs['poster_url_1'] = "https://drive.google.com/uc?export=download&id=1eFl5af7eimuPVop8W1eAUr4cCmVLn8Kt"
            context_bm_bs['poster_url_2'] = "https://drive.google.com/uc?export=download&id=1eFl5af7eimuPVop8W1eAUr4cCmVLn8Kt"
    except:
    ...
    try:
        if BackgroundVideo.objects.filter().last():   
            ...
            context_bm_bs['video_url'] = video.link_video
            context_bm_bs['video_type'] = video.type_video
        elif not BackgroundVideo.objects.filter().last():
            context_bm_bs['video_url'] = "https://drive.google.com/uc?export=download&id=1iRN8nKryM2FKAltnuOq1Qk8MUM-hrq2U"

            context_bm_bs['video_type'] = "mp4"
    except:
    ...
    try:
        if BackgroundMusic.objects.filter().last():   
            ...
            context_bm_bs['music_url_1'] = music.link_music_1
            context_bm_bs['music_type_1'] = music.type_music_1
            context_bm_bs['music_url_2'] = music.link_music_2
            context_bm_bs['music_type_2'] = music.type_music_2
        elif not BackgroundMusic.objects.filter().last(): 
            context_bm_bs['music_url_1'] = "https://www.orangefreesounds.com/wp-content/uploads/2022/02/Relaxing-white-noise-ocean-waves.mp3"
            context_bm_bs['music_type_1'] = "mp3"
            context_bm_bs['music_url_2'] = "https://orangefreesounds.com/wp-content/uploads/2022/05/Piano-lullaby.mp3"
            context_bm_bs['music_type_2'] = "mp3"
    except:
        context_bm_bs['music_url_1'] = "https://www.orangefreesounds.com/wp-content/uploads/2022/02/Relaxing-white-noise-ocean-waves.mp3"
        context_bm_bs['music_type_1'] = "mp3"
        context_bm_bs['music_url_2'] = "https://orangefreesounds.com/wp-content/uploads/2022/05/Piano-lullaby.mp3"
