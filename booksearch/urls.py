...
from booksearch.req_author import addx_author, addauthor_serializer
# from booksearch.req_book import addx_book, addbook
from booksearch.req_book import addx_book, addbook_serializer
...
urlpatterns = [
    ...
    path('addx_book/addbook/', addbook_serializer, name='addbook'),
    # path('addx_author/addauthor/', addauthor, name='addauthor'),
    path('addx_author/addauthor/', addauthor_serializer, name='addauthor'),
