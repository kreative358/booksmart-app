...
def book_scrap(author_book_docer, title_download_docer):
    ...
    try:
        ...
        print("1. text_contains =", text_contains)
        time.sleep(0.6)
        ...
        try:
            ...
            print("NoSuchElementException link_first")
            try:
                link_first = driver.find_element(By.XPATH, text_contains)
                if link_first:
                    print("1. link_first")
        ...
        if btn_download:
            ...
            try:
                ...
                try:
                    ...
                    if downloaded_book:
                        pdf_url_download_found = downloaded_book.get_attribute("href")
                        print("pdf_url_download_found =", pdf_url_download_found)
                        ...
                        if file_name_found[:len(file_name)+1] == file_name:
                            pdf_url_download = pdf_url_download_found
                    ...
                    print(f"else except downloaded_book: Exception as {e}") 
                    try:
                        downloaded_book =  driver.execute_script('return document.querySelector("body > downloads-manager").shadowRoot.querySelector("#frb0").shadowRoot.querySelector("#file-link")')
                        if downloaded_book:
                            pdf_url_download_found = downloaded_book.get_attribute("href")
