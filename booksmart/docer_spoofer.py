...
class Spoofer(object):
    ...
    def __init__(self, country_id=['PL'], rand=True, anonym=True):
...
class DriverOptions(object):
    ...
    def __init__(self):
        self.lang_list = ['en']
        self.gpu = False
        self.reader_easyocr = easyocr.Reader(self.lang_list, self.gpu)
        ...
        self.chrome_options.add_argument("--excludeSwitches=['enable-automation']")
        self.chrome_options.add_argument("--disable-popup-blocking")
        self.chrome_options.add_argument("--disable-infobars")
        self.chrome_options.add_argument("--disable-notifications")
        self.chrome_options.add_argument("--disable-in-process-stack-traces")
        self.chrome_options.add_argument('--no-first-run --no-service-autorun --password-store=basic')
        ...
        # self.chrome_options.add_extension(r"/static/CJPALHDLNBPAFIAMEJDNHCPHJBKEIAGM_1_54_0_0.crx")
...
class WebDriver(DriverOptions):
    ...
    def __init__(self, path=''):
        ...
        self.book_id_book_scrap = self.book_id_book_scrap
    ...
    def get_driver(self):
        ...
        driver_my = uc.Chrome(desired_capabilities=capa, options=self.chrome_options)
        # driver.execute_script("Object.defineProperty(navigator, 'webdriver', {get: () => undefined})")
        driver_my.execute_script("Object.defineProperty(navigator, 'uc', {get: () => undefined})")
        driver_my.execute_cdp_cmd("Page.addScriptToEvaluateOnNewDocument", {
            "source":
...
def main():
    ...
    driver_my = WebDriver()
    driver = driver_my.driver_instance
...
if __name__ == "__book_scrap__":
    book_scrap()  

def book_scrap_ready(book_id_book_scrap_ready):
...
if __name__ == "__book_scrap_ready__":
    book_scrap_ready()    