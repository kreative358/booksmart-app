...
class RecordsView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        # context["form_search_post"] = ""
        # context["form_search_get"] = ""
        # context["form_search_get_author"] = ""
        parameters = ""
        values = ""
        dict_values = ""
        search_title = ""
        ...
        author_details_q = ""
        search_ordering = ""
        # context["author_details_q"] = ""
        # context['search_ordering'] = ""
        ...
        if len(context_get["books_result_queryset_list_sort"]) == 0:
            ...
            msgs = ["there are no books in the database, with entered parameters:<br>", context['parameters']]
            messages.info(request, "".join(msg for msg in msgs))
                ...
                try:
                    ...
                    if authors_result_found:
                        ...
                        if authors_found_by_surname:
                            ...
                            print("NO authors_found_by_surname")
                        # except Exception as e:
        ...
        if len(context_get["books_result_queryset_list_sort"]) == 0:
            if not authors_result_queryset:
                num_books_result = 0
                num_authors_result_set = 0
                filtered_books = []
                book_page_obj = filtered_books
        ...
        paginated_filtered_books = Paginator(context['book_page_obj'], 10) 
        page_number = request.GET.get('page')
        book_page_obj = paginated_filtered_books.get_page(page_number)
